...
#define USBD_VID                   0xFF00
#define USBD_PID                   0x0008

#define USBD_LANGID_STRING         0x419 /*0x409 en*/
#define USBD_MANUFACTURER_STRING   (uint8_t*)"AMT Electronics"

#define USBD_PRODUCT_HS_STRING        (uint8_t*)"PANGAEA CP-16 USB HS Mode"
#define USBD_SERIALNUMBER_HS_STRING   (uint8_t*)"xcv"//0x1FFF7A10
#define USBD_PRODUCT_FS_STRING        (uint8_t*)"PANGAEA CP-16 USB FS Mode"
#define USBD_SERIALNUMBER_FS_STRING   (uint8_t*)"xcv"//0x1FFF7A10
#define USBD_CONFIGURATION_HS_STRING  (uint8_t*)"PANGAEA CP-16 HS Config"
#define USBD_INTERFACE_HS_STRING      (uint8_t*)"PANGAEA CP-16 USB HS Interface"
#define USBD_CONFIGURATION_FS_STRING  (uint8_t*)"PANGAEA CP-16 FS Config"
#define USBD_INTERFACE_FS_STRING      (uint8_t*)"PANGAEA CP-16 USB FS Interface"
/**
  * @}
  */ 
