...
#define _DF1S	0
#define _EXCVT {0x80,0x81,0x82,0x82,0x84,0x85,0x86,0x87,0x88,0x89,0x8A,0x8B,0x8C,0x8D,0x8E,0x8F, \
                                0x80,0x91,0x92,0x93,0x94,0x95,0x96,0x97,0x98,0x99,0x8A,0x9B,0x8C,0x8D,0x8E,0x8F, \
				0xA0,0xA2,0xA2,0xA3,0xA4,0xA5,0xA6,0xA7,0xA8,0xA9,0xAA,0xAB,0xAC,0xAD,0xAE,0xAF, \
...
const char* ff_error_str[FR_ERROR_CODE_COUNT] =  {
        "FR_OK", // = 0,                              /* (0) Succeeded */
...
const char* f_err2str(FRESULT code)
{
  return code < FR_ERROR_CODE_COUNT ?  ff_error_str[code] : "f_err2str: invalid arg"  ;
}
