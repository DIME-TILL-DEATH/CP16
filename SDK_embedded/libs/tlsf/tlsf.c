...
#ifdef __TLSF_USE_USB_CONSOLE_PRINTF__
    int  usb_condole_printf(const char* format, ...) __attribute__ ((noinline,used));
    #define printf usb_condole_printf
    # define tlsf_assert(__e)  ((__e) ? (void)0 : usb_condole_printf ("tlsf_assert in %s %s", __FILE__, __LINE__))
#else
    #define printf(...)
    # define tlsf_assert(__e)   while(!__e){ asm volatile ("mov r0,r0 \n mov r0,r0 \n mov r0,r0 \n"); }
#endif
...
/* Private constants: do not modify. */
     ...
     #define TLSF_FL_INDEX_MAX 20
     #warning tlsf: TLSF_FL_INDEX_MAX set default as 16
#endif
...
enum tlsf_private
{
	...
	*/
	FL_INDEX_MAX = 32,
#else
	FL_INDEX_MAX = TLSF_FL_INDEX_MAX ,//  30, - this value  is default for tlsf 3.0
#endif
