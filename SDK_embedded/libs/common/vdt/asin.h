...
inline double fast_asin(double x){	
	...
	zz = details::sqrt(zz+zz);
	double z = details::VDT_PI_4 - zz;
...
inline double fast_acos( double x ){return details::VDT_PI_2  - fast_asin(x);}

//------------------------------------------------------------------------------

inline float fast_acosf( float x ){return details::VDT_PI_2_F  - fast_asinf(x);}
