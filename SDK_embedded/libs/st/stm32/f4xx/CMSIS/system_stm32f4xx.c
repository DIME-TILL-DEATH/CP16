...
#if defined (STM32F427_437xx) || defined (STM32F429_439xx)
#define PLL_N      pll_configs[PLL_CONFIG].N /*360*/
/* SYSCLK = PLL_VCO / PLL_P */
#define PLL_P      2
#endif /* STM32F427_437x || STM32F429_439xx */
...
/**
  ...
  * @retval None
  */
static void SetSysClockHSE(uint32_t source)
{
/******************************************************************************/
...
void SystemInit(void)
{
  ...
  /* Configure the System clock source, PLL Multiplier and Divider factors,
     AHB/APBx prescalers and Flash settings ----------------------------------*/
#if ( OSC_TYPE == 1 )
  SetSysClockHSE(OSC_TYPE);
#elif ( OSC_TYPE == 2 )
  SetSysClockHSI();
#elif ( OSC_TYPE == 3 )
  SetSysClockHSE(OSC_TYPE);
#else
  #error "OSC_TYPE is undefined or OSC_TYPE_UNKNOWN"
#endif
...
*/
  ...
  // set vector location as linker .vec_table section relocate
  extern uint32_t __vec_start__ ;
  SCB->VTOR = (__IO uint32_t)&__vec_start__ ;
