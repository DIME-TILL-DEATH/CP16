...
#define SD_MAX_VOLT_TRIAL               ((uint32_t)0x00000FFF)
...
const char* SD_Error2Msg(SD_Error code)
{
  return SD_ErrorMgs[code] ;
}
...
SDCardState SD_GetState(void)
{
  ...
  if(SD_LowLevel_Detect()== SD_PRESENT)
  {
