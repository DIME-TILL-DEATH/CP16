...
# Possible CP16PA, CP16RV, LA3PA, LA3RV
MODIFICATION=CP16RV
FIRMWARE_VER="1.05.05"

ifeq ($(MODIFICATION), CP16PA)
	HARDWARE_DEFS+=-D__PA_VERSION__ -DAMT_DEV_ID=3
	DEV_DESCRIPTION=\"cp16_module\"
	PROJECT_DESCRIPTION=\"cp16pa\"
	FIRMWARE_NAME="CP16PA______"
	FIRMWARE_PREFIX="PA."	
else ifeq ($(MODIFICATION), CP16RV)
	HARDWARE_DEFS+=-D__RV_VERSION__ -DAMT_DEV_ID=2
	DEV_DESCRIPTION=\"cp16_module\"
	PROJECT_DESCRIPTION=\"cp16rv\"
	FIRMWARE_NAME="CP16RV______"
	FIRMWARE_PREFIX="RV."
else ifeq ($(MODIFICATION), LA3PA)
	HARDWARE_DEFS+=-D__PA_VERSION__ -DAMT_DEV_ID=6 -D__LA3_MOD__
	DEV_DESCRIPTION=\"la3_module\"
	PROJECT_DESCRIPTION=\"la3pa\"
	FIRMWARE_NAME="LA3_PA_"
	FIRMWARE_PREFIX="PA."
else ifeq ($(MODIFICATION), LA3RV)
	HARDWARE_DEFS+=-D__RV_VERSION__ -DAMT_DEV_ID=5 -D__LA3_MOD__
	DEV_DESCRIPTION=\"la3_module\"
	PROJECT_DESCRIPTION=\"la3rv\"
	FIRMWARE_NAME="LA3_RV."
	FIRMWARE_PREFIX="RV."
endif
