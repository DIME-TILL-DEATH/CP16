...
//	pre_processing_func = dummy_processing_stage;
//	post_processing_func = eq_processing_stage;
...
extern "C" void DMA1_Stream3_IRQHandler()
{
	...
	pre_processing_func(processing_sample, processing_sample);
	//--------------------------Compr + Gate--------------------------------------------
...
//	}
	...
	post_processing_func[0](processing_sample, processing_sample);
